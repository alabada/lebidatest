...
//            outStream.close();
            ...
            //在二维码中加入图片 LogoConfig中设置Logo的属性
            LogoConfig logoConfig = new LogoConfig();
            addLogoToQRCode(qrcFile, logoFile, logoConfig);
            ...
            //用来存放带有logo+文字的二维码图片
            String newImageWithText = "E:/QRCodeImage/imageWithText.jpg";
            //带有logo的二维码图片
            String targetImage = "E:/QRCodeImage/newPic.jpg";
            //附加在图片上的文字信息
