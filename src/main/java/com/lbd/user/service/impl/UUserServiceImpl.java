package com.lbd.user.service.impl;

import com.lbd.common.dao.UUserMapper;
import com.lbd.common.dao.UUserRoleMapper;
import com.lbd.common.model.UUser;
import com.lbd.common.model.UUserRole;
import com.lbd.common.utils.LoggerUtils;
import com.lbd.core.mybatis.BaseMybatisDao;
import com.lbd.core.mybatis.page.Pagination;
import com.lbd.core.shiro.session.CustomSessionManager;
...
public class UUserServiceImpl extends BaseMybatisDao<UUserMapper> implements UUserService {
    ...
    @Override
    public int updateByOpenId(UUser entity) {
        return userMapper.updateByOpenId(entity);
    }

    @Override
    public int updateByOpenIdSelective(UUser entity) {
        return userMapper.updateByOpenIdSelective(entity);
    }
    ...
    @Override
    public UUser findUserByOpenId(String openId) {
        return userMapper.findUserByOpenId(openId);
    }

    @SuppressWarnings("unchecked")
    @Override
    public Pagination<UserBo> findByPage(Map<String, Object> resultMap,
